...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 04, 2021 at 02:35 PM
...
(5, 'rambhai', 'tcs@gmail.com', '$2a$12$7KNAgxGZsJGtUNMsN81C1euU8LNLdjlRbxHIzK2qU6UMe8mM3JEQ2', 'tcs', 'www.tcs.com', 'Pune', 'Private Limited Company', 'IT Company ', '9913919327', 'more than 1000'),
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `result10` float NOT NULL,
  `result12` float NOT NULL,
  `avgcgpa` float NOT NULL,
...
(39, 'adarsh', 'adarsh@gmail.com', '$2a$12$.1eGhO1/bImq2TQgW6aYo.kxBZVXsh19OZeLFT3.pOkIFUcNGmbsi', 'ddu', '20', 'surat', 'male', '9999966554', 'NO', 'computer', 2022, 85, 90, 8.67, 1),
(200, 'anjan', 'anjan@gmail.com', '$2a$12$Pg0ZzX6XZHkagJL75HUTSOTvL8RKBmQLgE4V3cbiMkKv9mV4sMGlq', 'tpocollege', '20', 'Jamnagar', 'male', '9919455555', 'NO', 'Civil', 2023, 94, 90, 9.08, 0),
(207, 'charmi Mehta', 'charmi@gmail.com', '$2a$12$122M1XJmR.CAa8zrXEwu2OB3cBJhOVZFPfc55Gnpcdz1mrJNizBh.', 'ddu', '21', 'dwarka', 'female', '9876549877', 'YES', 'Computer', 2022, 91, 85, 8.5, 0),
(208, 'jay sanghani', 'jay@gmail.com', '$2a$12$GWWzfVGfK52ZJ.xZQa.vLu03dczV.ZPa1Ntx6hZiETR9xkD0pxMKq', 'ddu', '21', 'surat', 'male', '9876543219', 'YES', 'MBA', 2021, 70, 75, 7.9, 2),
(209, 'kailash', 'kailash@gmail.com', '$2a$12$GR8g7QKL29BVBDHIOdeC2eRtst7wypSGBz9BBb3dQ.UBGdkIp0KOS', 'ddu', '20', 'nadiad', 'male', '9876543210', 'YES', 'MCA', 2022, 85, 70, 8.3, 1),
(210, 'dip Vachhani', 'dip@gmail.com', '$2a$12$moQY.KzFhGyYF49rM3ZNKepLl/cYtoSHKdRxkdBgIBPkT3ebx6RdO', 'ddu', '18', 'jamnagar', 'male', '9876598766', 'YES', 'Computer', 2021, 80, 95, 9, 0),
(211, 'shyam', 'shaym@gmail.com', '$2a$12$8dxy/dYpk94LBKaoapBBQOTAssbhJ3z.J5PgUtrEU2A7E8LLisDF.', 'ddu', '20', 'surat', 'male', '9873216544', 'YES', 'It', 2021, 92, 95, 7.77, 0),
(212, 'drashty patel', 'drashty@gmail.com', '$2a$12$q33tcFQm4EzKZchI7CBnLOafDrIdpD2UqHQPXa72kJD3sVj71qo9i', 'ddu', '21', 'jamnagar', 'female', '9427422337', 'YES', 'Chemical', 2022, 90, 90, 9, 0),
...
(254, 'Darshak Kathiriya', 'darshak@gmail.com', '$2a$12$OU/.rQC1xpIsuQUclL3t.uiGPqtZfwmcn7LyXR81YRsU8V4aoz0eG', 'tpocollege', '18', 'jamnagar', 'male', '9876598765', 'YES', 'It', 2021, 90, 95, 9, 0),
(255, 'ramesh sanghani', 'ramesh@gmail.com', '$2a$12$q5yDzxDDzt8dlwCW4BztCudU98YGfbiizKHveloi1KqiXkSibkhky', 'tpocollege', '20', 'surat', 'male', '9876543219', 'YES', 'MBA', 2021, 70, 75, 7.9, 1),
(256, 'mahesh', 'mahesh@gmail.com', '$2a$12$ShnXjXMgekd2aIp9.F/qa.0lM/3oQxv0XzwdOp6doMKGVNc3C6OFy', 'tpocollege', '20', 'nadiad', 'male', '9876543210', 'YES', 'Computer', 2022, 85, 70, 8.3, 2),
(257, 'ayushi ajudiya', 'ayushi@gmail.com', '$2a$12$1nNV0kKxxSzF8DlK8zUP2O3LFoPYjvzkU5aPBZqbKKGmFfiLYGhHm', 'tpocollege', '19', 'jamnagar', 'female', '9427422337', 'YES', 'Chemical', 2022, 90, 90, 9, 0),
(258, 'Nihal Limbani', 'nihal@gmail.com', '$2a$12$G.bxGyl/iOcO8ALLHuo3ZOwsOFpiPT2ftUdi/bu3jl056OjQww0ka', 'tpocollege', '19', 'dwarka', 'male', '9876549876', 'YES', 'Computer', 2022, 91, 85, 8.5, 0),
(259, 'suresh', 'suresh@gmail.com', '$2a$12$U38VJAd2zXSXdvBT.3wH8OPRAK0.bbwt58iSImpXWH0Aq0Y6C.Vdq', 'tpocollege', '20', 'surat', 'male', '9873216544', 'YES', 'It', 2021, 92, 95, 7.77, 0);
...
(36, 'TPO', 'tpo@gmail.com', '$2a$12$.7EI0jWvpRUk0H/OwkqGE.p091.5PLrzMf.SxLJ0Y2ymfHJuCKsIy', 'tpocollege', 'Jamnangar', '9992255555', 'www.tpo.com', '10', 'yes', 'no', 'yes', 'no');
COMMIT;
